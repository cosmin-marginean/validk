...
class NestedObjectTest : StringSpec({
    ...
    "nested object" {
        ...
        validation.validate(Person("John Smith", Address("London", "ABCD"))).success shouldBe true
    }
    ...
    "nested collection" {
        ...
        validation.validate(Parent("John Smith", listOf(Child("One"), Child("Two")))).success shouldBe true
